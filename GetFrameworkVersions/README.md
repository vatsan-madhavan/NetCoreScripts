...
SYNTAX
    ...
    [[-SdkFolder] <String>] [-ReDownloadSdk] [-DoNotFallbackToProgramFiles] [<CommonParameters>]
...
PARAMETERS
    ...
    https://dotnetcli.azureedge.net/dotnet/Sdk/3.1.100-preview3-014645/dotnet-sdk-3.1.100-preview3-014645-win-x64.zip
           VERBOSE: dotnet-install: Extract-Dotnet-Package -ZipPath "C:\Users\username\AppData\Local\Temp\qdsgbwaw.isr" -OutPath 
